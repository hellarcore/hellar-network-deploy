# [1.0.0](https://github.com/hellarcore/hellar-network-deploy/compare/v1.0.0-dev.8...v1.0.0) (2024-01-13)

* fix(terraform): InvalidInput error  in https://github.com/hellarcore/hellar-network-deploy/pull/499
* feat!: core v20 and platform v1.0.0 updates  in https://github.com/hellarcore/hellar-network-deploy/pull/490
* feat: initial multi-stage deployment  in https://github.com/hellarcore/hellar-network-deploy/pull/520
* chore: merge master  in https://github.com/hellarcore/hellar-network-deploy/pull/523
* fix: multiple initilalizations of bls  in https://github.com/hellarcore/hellar-network-deploy/pull/512
* fix: ansible-lint no-changed-when  in https://github.com/hellarcore/hellar-network-deploy/pull/532
* chore: update logs syntax for drive 1.0.0  in https://github.com/hellarcore/hellar-network-deploy/pull/526
* feat: hellarmate for seeds  in https://github.com/hellarcore/hellar-network-deploy/pull/535
* fix: hellarmate config changed on every run  in https://github.com/hellarcore/hellar-network-deploy/pull/537
* chore: remove unused todo tasks  in https://github.com/hellarcore/hellar-network-deploy/pull/538
* chore: speedup address import  in https://github.com/hellarcore/hellar-network-deploy/pull/539
* fix: hpmn methods are deprecated  in https://github.com/hellarcore/hellar-network-deploy/pull/540
* chore: support Platform v1.0.0  in https://github.com/hellarcore/hellar-network-deploy/pull/541
* feat(hellarmate): optional initial core chain locked height  in https://github.com/hellarcore/hellar-network-deploy/pull/542
* fix: misnamed vars  in https://github.com/hellarcore/hellar-network-deploy/pull/543
* chore: remove sentinel tests  in https://github.com/hellarcore/hellar-network-deploy/pull/544
* chore: revert var name to private_key  in https://github.com/hellarcore/hellar-network-deploy/pull/546
* chore: revert replace hellarmate config command with config file stat  in https://github.com/hellarcore/hellar-network-deploy/pull/547
* chore(release): release 1.0.0-dev.2  in https://github.com/hellarcore/hellar-network-deploy/pull/548
* fix: initial_core_chain_locked_height missing even if defined  in https://github.com/hellarcore/hellar-network-deploy/pull/549
* test(hapi): fix data contract not found test  in https://github.com/hellarcore/hellar-network-deploy/pull/550
* refactor: remove `isseednode`  in https://github.com/hellarcore/hellar-network-deploy/pull/552
* fix: Error: Timeout of 20000ms exceeded  in https://github.com/hellarcore/hellar-network-deploy/pull/553
* feat: coinjoin mixing  in https://github.com/hellarcore/hellar-network-deploy/pull/528
* fix(hellarmate): switch back to outdated certificate on deploy  in https://github.com/hellarcore/hellar-network-deploy/pull/556
* chore: remove sentinel  in https://github.com/hellarcore/hellar-network-deploy/pull/555
* chore: update docker release and deps  in https://github.com/hellarcore/hellar-network-deploy/pull/557
* fix: objc[32080]: +[__NSCFConstantString initialize] may have been in…  in https://github.com/hellarcore/hellar-network-deploy/pull/558
* docs: clarify the purpose of running `hellarmate config`  in https://github.com/hellarcore/hellar-network-deploy/pull/559
* chore: update default versions in config and add vars  in https://github.com/hellarcore/hellar-network-deploy/pull/560
* feat(tests): improve smoke tests error reporting  in https://github.com/hellarcore/hellar-network-deploy/pull/561
* fix: AssertionError: no block info  in https://github.com/hellarcore/hellar-network-deploy/pull/562
* fix(tests): invalid hapi error handling  in https://github.com/hellarcore/hellar-network-deploy/pull/564
* fix(tests): unsupported hapi tests for seed nodes  in https://github.com/hellarcore/hellar-network-deploy/pull/565
* chore: create tenderhellar role for seed nodes  in https://github.com/hellarcore/hellar-network-deploy/pull/567
* chore: fix linting errors  in https://github.com/hellarcore/hellar-network-deploy/pull/568
* chore: install jq once only  in https://github.com/hellarcore/hellar-network-deploy/pull/569
* chore: replace cloudwatch mon script with cloudwatch agent  in https://github.com/hellarcore/hellar-network-deploy/pull/570
* chore: add drive abci epoch time to config  in https://github.com/hellarcore/hellar-network-deploy/pull/571
* chore: push Drive logs from the file  in https://github.com/hellarcore/hellar-network-deploy/pull/573
* fix: hellarmate restart logic  in https://github.com/hellarcore/hellar-network-deploy/pull/575
* chore: update filebeat platform template for tenderhellar logs  in https://github.com/hellarcore/hellar-network-deploy/pull/576
* fix(test)!: wrong error expected  in https://github.com/hellarcore/hellar-network-deploy/pull/578
* chore(release): bump version to 1.0.0-dev.8  in https://github.com/hellarcore/hellar-network-deploy/pull/579
* chore: limit metrics collection  in https://github.com/hellarcore/hellar-network-deploy/pull/580
* chore: update cloudwatch monitoring  in https://github.com/hellarcore/hellar-network-deploy/pull/572
* chore: update filebeat templates to support drive from file and tenderhellar only on logs nodes  in https://github.com/hellarcore/hellar-network-deploy/pull/581
* chore: use instance store for logs data  in https://github.com/hellarcore/hellar-network-deploy/pull/563
* chore: make monitoring config more granular  in https://github.com/hellarcore/hellar-network-deploy/pull/583
* chore: change instance type  in https://github.com/hellarcore/hellar-network-deploy/pull/584
* feat!: add GroveDb operations log  in https://github.com/hellarcore/hellar-network-deploy/pull/582
* fix: extra comma causing json schema validation error  in https://github.com/hellarcore/hellar-network-deploy/pull/586
* chore: enable full text indexing on tenderhellar errors  in https://github.com/hellarcore/hellar-network-deploy/pull/588
* fix: drive log specification missing grovedb ops  in https://github.com/hellarcore/hellar-network-deploy/pull/589
* chore: update terraform and deps  in https://github.com/hellarcore/hellar-network-deploy/pull/590
* fix: alarm dimensions  in https://github.com/hellarcore/hellar-network-deploy/pull/587
* chore: log only grovedb operaions  in https://github.com/hellarcore/hellar-network-deploy/pull/592
* feat: generate minimal hellar.conf file in configs repo  in https://github.com/hellarcore/hellar-network-deploy/pull/593
* chore: make logs node type a variable  in https://github.com/hellarcore/hellar-network-deploy/pull/594
* chore(hellarmate): change ssl dir path  in https://github.com/hellarcore/hellar-network-deploy/pull/595
* chore(hellarmate): add `core.docker.commandArgs` option  in https://github.com/hellarcore/hellar-network-deploy/pull/597
* fix: *_hpmn methods are deprecated. Use the related *_pro methods  in https://github.com/hellarcore/hellar-network-deploy/pull/598
* Fix: ensure seed listens  in https://github.com/hellarcore/hellar-network-deploy/pull/599
* chore: update to new hellarmate version  in https://github.com/hellarcore/hellar-network-deploy/pull/601
* feat: upgrade Node to 20 (LTS)  in https://github.com/hellarcore/hellar-network-deploy/pull/600
* fix: increase timeout on sendtx test  in https://github.com/hellarcore/hellar-network-deploy/pull/602
* chore: fix mixer nodes  in https://github.com/hellarcore/hellar-network-deploy/pull/603
* chore: open tenderhellar metrics port for private network  in https://github.com/hellarcore/hellar-network-deploy/pull/604
* chore!: update to hellarmate 1.0.0  in https://github.com/hellarcore/hellar-network-deploy/pull/605
* fix: invalid tenderhellar metrics host  in https://github.com/hellarcore/hellar-network-deploy/pull/606
* chore!: update hellarmate config for v1.0.0  in https://github.com/hellarcore/hellar-network-deploy/pull/608
* feat: configure grovedb operation logs  in https://github.com/hellarcore/hellar-network-deploy/pull/609
* fix: object of type 'NoneType' has no len()  in https://github.com/hellarcore/hellar-network-deploy/pull/610
* chore: update es 8.11.3  in https://github.com/hellarcore/hellar-network-deploy/pull/611
* feat: ssh to host command  in https://github.com/hellarcore/hellar-network-deploy/pull/614
...
* network fork on restart ([#263](https://github.com/hellarcore/hellar-network-deploy/issues/263))
...
# [0.16.0](https://github.com/hellarcore/hellar-network-deploy/compare/v0.15.0...v0.16.0) (2020-10-28)
...
* handle hapi Client "not found" response ([eefb263](https://github.com/hellarcore/hellar-network-deploy/commit/eefb263bce272ef96aef5f3ade65d74adef26e4e))
